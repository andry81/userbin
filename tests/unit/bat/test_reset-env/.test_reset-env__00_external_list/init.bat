...
set "RESET_ENV_FILE_NAME=%~1"
set "TEST_DATA_FILE_IN_DIR=%~2"
set "TEST_DATA_FILE_REF_DIR=%~3"
set "RESET_ENV_FLAGS_CMD_LINE=%~4"

if not defined RESET_ENV_FILE_NAME exit /b 255
...
call "%%CONTOOLS_ROOT%%/std/canonical_path.bat" TEST_TEMP_DATA_OUT_FILE "%%TEST_TEMP_DIR_PATH%%\%%RESET_ENV_FILE_NAME%%"
